...
import Style from '@/app/products/[slug]/productDetail.module.css'
...
export const Cart = ({data_Product}:{data_Product:any}) => {
...
export function Card()
{
    ...
    {arr.map((para:any,index:number)=>{
        ...
        <div>
        <Image src={urlForImage(para.productImage).url()} width={170} height={170} alt="Loading...." className=' rounded-2xl'></Image>
         </div>
         <div>
